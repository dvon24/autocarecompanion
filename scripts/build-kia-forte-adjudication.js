...
const REWRITE_CARDS = {
  [REWRITE_IDS.hecu]: {
    ...
    commerceDecision: 'dealer-only-no-retail-part-safety-recall', severity: 'critical', confidence: 'high',
  ...
  [REWRITE_IDS.airbag]: {
    ...
    commerceDecision: 'dealer-only-no-retail-part-safety-recalls', severity: 'critical', confidence: 'high',
