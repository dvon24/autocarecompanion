...
const { MISMATCH_SOURCES, REWRITE_CARDS, SOURCES } = require('./build-honda-odyssey-adjudication');

const PACKET = path.resolve(__dirname, '..', 'data', 'known-issue-honda-odyssey-adjudication-2026-08-06.json');
...
async function main() {
  ...
  const scopeErrors = [];
  if (rows.length !== 12) scopeErrors.push('expected twelve rewrite rows');
