...
const { REWRITE_CARDS, SOURCES } = require('./build-honda-clarity-adjudication');

const PACKET = path.resolve(__dirname, '..', 'data', 'known-issue-honda-clarity-adjudication-2026-08-06.json');
...
async function main() {
  ...
  const scopeErrors = [];
  if (rows.length !== 2) scopeErrors.push('expected two rewrite rows');
