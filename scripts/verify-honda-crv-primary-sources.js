...
const { REWRITE_CARDS, SOURCES } = require('./build-honda-crv-adjudication');

const PACKET = path.resolve(__dirname, '..', 'data', 'known-issue-honda-crv-adjudication-2026-08-06.json');
...
async function main() {
  ...
  const scopeErrors = [];
  if (rows.length !== 19) scopeErrors.push('expected 19 rewrite rows');
