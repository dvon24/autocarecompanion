...
const { buildPacket, SNAPSHOT } = require('./build-land-rover-range-rover-adjudication');
const { validatePacket } = require('./validate-land-rover-range-rover-adjudication');

const snapshot = JSON.parse(fs.readFileSync(SNAPSHOT, 'utf8'));

test('Range Rover packet passes the full safety contract', () => {
