...
const { EXPECTED_RECALLS, PDF_SHA256, RECALL_QUERIES, SOURCES, VISUALLY_INSPECTED_PAGES } = require('./build-jaguar-f-pace-adjudication');
...
async function main() {
  ...
  console.log(JSON.stringify({ passed, checkedOn: '2026-08-06', documentCount: documents.length, documents, recalls }, null, 2));
