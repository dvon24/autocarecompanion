...
(async()=>{
 ...
 const picked=new Set(JSON.parse(fs.readFileSync('data/_recall-wave-batch2.json','utf8')));
 const by={};
 ...
 fs.writeFileSync('data/_recall-wave-targets-b2.json',JSON.stringify(targets,null,2));
