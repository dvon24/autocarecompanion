...
const EXPECTED_RECALLS = {
  2003: ['03V164000', '03V476000', '05V555000', '06V244000', '06V328000', '15V226000', '15V287000', '16V349000', '20V008000', '21V139000'],
...
async function main() {
  ...
  const passed = pdf.passed && recalls.length === 10 && recalls.every((item) => item.passed);
