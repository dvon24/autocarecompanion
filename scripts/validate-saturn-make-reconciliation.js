...
const { buildReconciliation, OUTPUT_FILE } = require('./build-saturn-make-reconciliation');
...
function validateReconciliation(report) {
  ...
  if (report.summary.models !== 9 || report.summary.rows !== 37 || report.summary.retained !== 11 || report.summary.held !== 26 || report.summary.pagesPreservedPublished !== 37) errors.push('Saturn make totals drifted');
