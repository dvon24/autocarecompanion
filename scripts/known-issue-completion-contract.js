...
const COMMERCE_PIPELINE_IMPLEMENTATION_FILES = Object.freeze([
  ...
  'src/lib/verified-retailer-product.ts',
  'src/lib/known-issue-part-search.ts',
  'scripts/build-known-issue-part-search-queue.ts',
  'scripts/review-known-issue-part-search-results.ts',
  'scripts/evaluate-known-issue-part-search-lane.ts',
  'scripts/evaluate-known-issue-part-search-experiment.ts',
  'scripts/discover-known-issue-part-search-results.ts',
