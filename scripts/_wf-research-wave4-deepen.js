/**
 * RESEARCH WAVE 4 (DEEPEN) — the 11 models wave 3 never reached — Mercedes-Benz depth + the modern-EV thin set.
 *
 * Two groups:
 ...
 *
 *   Workflow({ scriptPath: 'scripts/_wf-research-wave4-deepen.js' })
 *
 ...
 *
 * DEPLOY HOLD IS ACTIVE. Nothing here writes to the DB. Save to data/research-wave4-<date>.json
 * and stop. See data/_SESSION-STATE-known-issues.md for the hold and the deploy sequence.
 *
 * Exclusions exported by scripts/_export-research-exclusions-wave4.js. Embedded rather than
 * passed via the `args` global, which is unreliable.
 */
export const meta = {
  name: 'research-wave4-deepen',
  description: 'Wave-4: the 11 models wave 3 missed when the WebSearch budget died. Forum-weighted discover + adversarial verify',
  phases: [
    { title: 'Discover' },
    { title: 'Verify' },
  ],
