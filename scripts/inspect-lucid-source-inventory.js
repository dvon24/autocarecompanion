...
async function inspect({ terms = [], model = 'AIR' } = {}) {
  ...
  return { communicationCounts, communicationTotal: Object.values(communicationCounts).reduce((sum, count) => sum + count, 0), relevantCommunications, recallCounts, recallRows };
}
