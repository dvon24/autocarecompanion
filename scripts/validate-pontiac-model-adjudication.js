...
const { buildPacket, citationsFor, commerceDecisionFor } = require('./build-pontiac-model-adjudication');
const { getContract } = require('./pontiac-model-adjudication-contracts');
