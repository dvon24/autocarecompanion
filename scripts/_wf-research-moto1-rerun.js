 ...
 */
export const meta = {
  name: 'research-moto1-rerun',
  description: 'Motorcycle pilot RE-RUN: the 4 nameplates whose discover agents returned empty on search-budget exhaustion, kept separate from the automotive catalog via vehicleType. Forum-weighted discover + adversarial verify',
  phases: [
    { title: 'Discover' },
    { title: 'Verify' },
  ],
...
log(`Motorcycle RE-RUN: ${TARGETS.length} nameplates that returned EMPTY last night on search budget, not on absence of issues`)
