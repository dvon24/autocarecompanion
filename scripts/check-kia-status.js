...
const kia = data.issues.filter(i => (i.vehicleMatch && i.vehicleMatch.make === 'Kia') || i.make === 'Kia');
console.log('=== KIA ISSUES BY MODEL ===');
const models = {};
...
console.log('\nTotal: ' + kia.length + ' issues, ' + totalNR + ' needsReview, ' + totalUnreviewed + ' unreviewed');
