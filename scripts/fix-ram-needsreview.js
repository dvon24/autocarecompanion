...
data.issues.forEach(function(issue) {
  ...
  if (vm.make !== 'RAM' && issue.make !== 'RAM' && vm.make !== 'Ram' && issue.make !== 'Ram') return;
  ...
  if (hadNeedsReview) {
    if (!issue.reviewedOn) issue.reviewedOn = "2026-02-24";
    issuesFixed++;
...
console.log('\nCleared ' + cleared + ' needsReview flags across ' + issuesFixed + ' RAM issues');
