...
const jeep = data.issues.filter(i => (i.vehicleMatch && i.vehicleMatch.make === 'Jeep') || i.make === 'Jeep');

console.log('=== JEEP ISSUES BY MODEL ===');
const models = {};
let totalNR = 0;
...
console.log('\nTotal: ' + jeep.length + ' issues, ' + totalNR + ' needsReview, ' + totalUnreviewed + ' unreviewed');
