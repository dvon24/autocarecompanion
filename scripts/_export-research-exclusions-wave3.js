/**
 * Export existing published + pending_review titles for the wave-3 targets
...
pool.on('error', () => {});
const TARGETS = [
  ['Mercedes-Benz','GLB'],['Mercedes-Benz','GLA'],['Mercedes-Benz','E-Class'],['Mercedes-Benz','CLA'],
  ['Mercedes-Benz','GLK-Class'],['Mercedes-Benz','EQE'],['Mercedes-Benz','EQB'],['Mercedes-Benz','EQS SUV'],
...
(async () => {
  ...
  fs.writeFileSync('data/research-wave3-exclusions.json', JSON.stringify(out, null, 2));
