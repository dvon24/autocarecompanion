...
const montana = require('./pontiac-montana-adjudication-contract');
const solstice = require('./pontiac-solstice-adjudication-contract');
const sunfire = require('./pontiac-sunfire-adjudication-contract');
const transAm = require('./pontiac-trans-am-adjudication-contract');
const vibe = require('./pontiac-vibe-adjudication-contract');
const CONTRACTS = Object.freeze({ Aztek: aztek, Bonneville: bonneville, Firebird: firebird, G6: g6, G8: g8, 'Grand Am': grandAm, 'Grand Prix': grandPrix, GTO: gto, Montana: montana, Solstice: solstice, Sunfire: sunfire, 'Trans Am': transAm, Vibe: vibe });
