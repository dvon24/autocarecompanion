...
async function verifyManual() {
  ...
  return {
    ...
    pages: MANUAL_SOURCE.pages,
    publicationNumber: MANUAL_SOURCE.publicationNumber,
    edition: MANUAL_SOURCE.edition,
    local,
    remote,
...
async function main() {
  const [communicationFiles, recallFiles, communications, recalls, manual] = await Promise.all([
