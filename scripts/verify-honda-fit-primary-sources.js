...
const { REWRITE_CARDS, SOURCES } = require('./build-honda-fit-adjudication');

const PACKET = path.resolve(__dirname, '..', 'data', 'known-issue-honda-fit-adjudication-2026-08-06.json');
