...
export const MAINTENANCE_SCHEDULES: Record<string, MaintenanceType> = {
  ...
  brake_service: {
    id: 'brake_service',
    name: 'Brake Service',
    description: 'Replace or service brake pads, rotors, or related hardware',
  ...
  tire_replacement: {
    ...
    description: 'Replace the installed tire set',
    defaultIntervalMiles: 40000,
  ...
  cooling_system_service: {
    id: 'cooling_system_service',
    name: 'Cooling System Service',
    description: 'Replace or service the radiator and cooling-system hardware',
