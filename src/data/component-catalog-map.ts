...
export const COMPONENT_CATALOG_MAP: ComponentMapping[] = [
  ...
  { pattern: /\b(sway[ -]?bar(?:\s+end)?\s+links?|stabilizer[ -]?bar(?:\s+end)?\s+links?|end links?)\b/i, productMatch: 'suspension springs components', partTypeMatch: 'stabilizer bar link', engineIndependent: true },
  { pattern: /\bcontrol[ -]?arm bushings?\b/i, productMatch: 'suspension springs components', partTypeMatch: 'control arm bushing', engineIndependent: true },
  { pattern: /\bcontrol[ -]?arm\b/i, productMatch: 'suspension springs components', partTypeMatch: 'control arm', engineIndependent: true },
  { pattern: /\bball joints?\b/i, productMatch: 'suspension springs components', partTypeMatch: 'ball joint', engineIndependent: true },
  { pattern: /\btie[ -]?rods?\b/i, productMatch: 'steering gear pump components', partTypeMatch: 'tie rod', engineIndependent: true },
  ...
  { pattern: /\b(u.?joints?|universal joints?)\b/i, productMatch: 'c/v axles boots', partTypeMatch: 'universal joint', engineIndependent: true },
