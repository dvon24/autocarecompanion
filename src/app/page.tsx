    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="flex flex-col">
        ...
        <section className="flex-1 flex flex-col items-center justify-center px-6 py-24 lg:py-32">
          ...
          {/* Main headline */}
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-center leading-[1.1] tracking-tight text-gray-900 mb-6 max-w-4xl">
            Expert guidance
            <br />
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8">
            <Link
              href="/get-started"
              className="inline-flex items-center justify-center px-8 py-4 bg-gray-900 text-white font-medium rounded-lg hover:bg-gray-800 transition-colors text-lg"
            >
              Get Started
            ...
            <button className="inline-flex items-center justify-center px-8 py-4 border border-gray-200 text-gray-700 font-medium rounded-lg hover:border-gray-300 hover:bg-gray-50 transition-colors text-lg">
              See How It Works
            </button>
          </div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Pre-Flight Check</h3>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Step-by-Step Guides</h3>
                <p className="text-gray-500 leading-relaxed">
