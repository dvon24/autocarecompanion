        ...
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-600 space-y-2">
              ...
              <li><strong>&quot;Vehicle Information Content&quot;</strong> means all vehicle-related informational content provided through the Services, including known issue articles, diagnostic trouble code (DTC) reference pages, maintenance schedules, vehicle specifications, and community-submitted repair data, whether generated by AI, compiled from public sources, or submitted by users.</li>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-lg font-medium text-gray-800 mb-2">4.2 Known Issues and Diagnostic Reference</h3>
            <p className="text-gray-600 leading-relaxed mb-4">
              An informational database of known vehicle issues, common problems, and diagnostic trouble code (DTC) reference data organized by vehicle make, model, and year. This content is compiled from publicly available sources and is provided for educational and informational purposes only. The Services also provide curated maintenance schedules with service intervals and specifications organized by vehicle trim and engine configuration.
            </p>

            <h3 className="text-lg font-medium text-gray-800 mb-2">4.3 Affiliate Links and Third-Party Retailers</h3>
            <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <h3 className="text-lg font-medium text-gray-800 mb-2">4.4 General Provisions</h3>
            <p className="text-gray-600 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">10. Disclaimers for Vehicle Information and AI Services</h2>
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-4">
              <p className="text-gray-800 font-medium mb-2">IMPORTANT DISCLAIMER</p>
              <p className="text-gray-700 text-sm leading-relaxed">
                ALL VEHICLE-RELATED INFORMATION PROVIDED THROUGH THE SERVICES — INCLUDING AI-GENERATED GUIDES, KNOWN ISSUE ARTICLES, DIAGNOSTIC TROUBLE CODE (DTC) REFERENCE PAGES, MAINTENANCE SCHEDULES, FLUID SPECIFICATIONS, PART RECOMMENDATIONS, AND COMMUNITY-SUBMITTED DATA — IS PROVIDED FOR INFORMATIONAL AND EDUCATIONAL PURPOSES ONLY AND IS NOT A SUBSTITUTE FOR PROFESSIONAL AUTOMOTIVE ADVICE. THIS INFORMATION IS DERIVED FROM PUBLICLY AVAILABLE SOURCES, MANUFACTURER DATA, AND USER CONTRIBUTIONS, AND MAY CONTAIN ERRORS, INACCURACIES, OR OMISSIONS. YOU MUST CONSULT YOUR VEHICLE&apos;S OWNER&apos;S MANUAL, A QUALIFIED MECHANIC, OR VERIFY ALL INFORMATION INDEPENDENTLY BEFORE RELYING ON IT.
              </p>
            </div>

            <h3 className="text-lg font-medium text-gray-800 mb-2">10.1 AI-Generated Content</h3>
            <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <h3 className="text-lg font-medium text-gray-800 mb-2">10.2 Known Issues and DTC Code Reference Data</h3>
            <p className="text-gray-600 leading-relaxed mb-4">
              The Services provide informational articles about known vehicle issues, common problems, and diagnostic trouble code (DTC) reference data. This editorial content is compiled from publicly available sources including manufacturer technical service bulletins, government databases, automotive forums, and industry publications. While we strive for accuracy, this content may not reflect the most current information, may not apply to your specific vehicle configuration, and should not be used as the sole basis for repair decisions. Always consult a qualified mechanic for diagnosis and repair.
            </p>

            <h3 className="text-lg font-medium text-gray-800 mb-2">10.3 Maintenance Schedules and Vehicle Specifications</h3>
            <p className="text-gray-600 leading-relaxed mb-4">
              The Services provide curated maintenance schedules and vehicle specifications, including service intervals, fluid capacities, and part specifications organized by vehicle make, model, year, and trim level. This data is compiled from publicly available manufacturer information and industry sources. These schedules are approximate guidelines and may differ from your vehicle&apos;s specific requirements based on driving conditions, geographic location, vehicle modifications, or manufacturer updates. Your vehicle&apos;s owner&apos;s manual is the authoritative source for all maintenance schedules and specifications.
            </p>

            <h3 className="text-lg font-medium text-gray-800 mb-2">10.4 Community-Submitted Content</h3>
            <p className="text-gray-600 leading-relaxed">
              The Services may display information submitted by other users, including repair experiences, cost reports, and fix recommendations. Community-submitted content is unverified, reflects individual experiences that may not be applicable to your vehicle or situation, and is not endorsed by us. We are not liable for any damages resulting from reliance on community-submitted information. Use such information at your own risk and always verify with a qualified professional.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 leading-relaxed">
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, WE SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING LOSS OF PROFITS, DATA, OR USE, ARISING FROM YOUR USE OF THE SERVICES, EVEN IF ADVISED OF THE POSSIBILITY THEREOF. THIS INCLUDES, WITHOUT LIMITATION, ANY DAMAGES ARISING FROM VEHICLE REPAIRS PERFORMED USING INFORMATION FROM THE SERVICES, RELIANCE ON KNOWN ISSUE ARTICLES OR DTC REFERENCE DATA, USE OF MAINTENANCE SCHEDULES OR VEHICLE SPECIFICATIONS, RELIANCE ON COMMUNITY-SUBMITTED CONTENT, PURCHASES MADE THROUGH AFFILIATE LINKS, OR RELIANCE ON AI-GENERATED CONTENT.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-lg font-medium text-gray-800 mb-2">17.1 Informal Good-Faith Negotiation</h3>
            <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <h3 className="text-lg font-medium text-gray-800 mb-2">17.2 Binding Arbitration</h3>
            <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <h3 className="text-lg font-medium text-gray-800 mb-2">17.3 Class Action Waiver</h3>
            <p className="text-gray-600 leading-relaxed">
