...
export const metadata: Metadata = {
  ...
  description:
    'Browse 2,200+ documented vehicle problems across 20 makes and 490+ models. Symptoms, repair costs, and solutions from real owner reports.',
  openGraph: {
    title: 'Known Vehicle Issues & Problems | Au7o',
    description:
      'Browse 2,200+ documented vehicle problems across 20 makes and 490+ models.',
