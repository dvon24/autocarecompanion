          ...
          <div className="max-w-4xl mx-auto px-6 py-6">
            <ScrollReveal delay={0} duration={600}>
              <div className="flex items-center gap-3 text-sm text-gray-500 mb-2">
                ...
                {guide.source === 'verified-procedure' && (
                  <>
            ...
            {/* Disclaimer - conditional based on verified vs AI-generated */}
                ...
                <div className="mt-4 p-4 bg-green-50 border border-green-200 rounded-xl">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm text-green-800">
                      <p className="font-medium">Verified Procedure</p>
                      <p className="mt-1">
                        Steps in this guide have been reviewed for accuracy on this specific vehicle.
                        Always confirm with your <strong>owner&apos;s manual</strong> for final specifications.
                        By using this guide, you accept responsibility for your repairs.{' '}
                        <a href="/terms" className="underline hover:text-green-900">See terms</a>.
                      </p>
                    </div>
                  </div>
                </div>
