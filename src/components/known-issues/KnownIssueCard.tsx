  ...
  return (
    <div id={issue.id} className="border border-[#E3DFD4] rounded-lg overflow-hidden transition-all scroll-mt-20 bg-[#FBFAF6]">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1 flex-wrap">
            ...
            {(() => {
              ...
              return (
                <span
                  className="text-xs font-medium px-2 py-0.5 rounded bg-[#EFEDE6] text-[#334155] border border-[#E3DFD4]"
                  title={title}
                >
                  {label}
                </span>
      ...
      >
          ...
          {/* Symptoms */}
          <div>
            <h4 className="text-sm font-medium text-[#0B1220] mb-2">Common Symptoms</h4>
            <ul className="space-y-1">
              {issue.symptoms.map((symptom, index) => (
                <li key={index} className="flex items-start gap-2 text-sm text-[#475569]">
                  <svg className="w-4 h-4 text-[#94A3B8] mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
          ...
          <IssueDiagnosticTools
            ...
            make={issue.vehicleMatch.make || vehicleInfo?.make}
          ...
          {issue.estimatedCost && (
            <div className="flex items-center gap-2 text-sm">
              <span className="text-[#64748B]">Typical repair cost:</span>
              <span className="font-medium text-[#0B1220]">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                ...
                <span className="text-xs font-medium text-[#334155]">Google</span>
              </a>
              {/* Reddit search */}
              <a
              ...
              >
                ...
                <span className="text-xs font-medium text-[#334155]">Reddit</span>
              </a>
              {/* YouTube search */}
              <a
              ...
              >
                ...
                <span className="text-xs font-medium text-[#334155]">YouTube</span>
              </a>
              {/* NHTSA */}
              <a
            ...
            <div className="flex gap-2 mt-3">
              {!userFix && (
                <button
                  ...
                  className="flex-1 py-2.5 px-4 border border-[#E3DFD4] text-[#475569] text-sm font-medium rounded-lg hover:bg-[#EFEDE6] hover:border-[#CBD5E1] transition-colors flex items-center justify-center gap-2"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
