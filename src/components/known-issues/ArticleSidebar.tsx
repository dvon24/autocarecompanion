      ...
      <nav className="sticky top-8 space-y-6" aria-label="Article navigation">
        ...
        <div className="space-y-2">
          ...
          <Link
            ...
            className="flex items-center justify-center gap-2 w-full py-2 px-3 text-sm font-medium text-[#3B82F6] border border-[#BFD4FB] rounded-lg hover:bg-blue-50 transition-colors"
          >
