...
- 2026-07-31: Production-verified the first accelerated BMW cohort (1 Series, 2 Series and 2 Series Active Tourer) on exact functional audit commit `9da3a2b22a32984608264c9edfd43eda84be9fba` and Ready Production deployment `dpl_9zqQKhKKu8USN1FUVjPHwpTEyQUH`. Twenty-four frozen records resolved to eight published and 16 archived records; all 44 commerce claims and 86 legacy commerce URL occurrences were removed, including the one claim/record/priority click, with zero commerce retained. Six exact ShowMeTheParts subscription-API lookups were used only as candidate/fitment evidence: the 2008 135i returned five water-pump candidates, one high-pressure-fuel-pump candidate, zero injector candidates and five turbocharger candidates; the 2014 228i returned zero timing-chain and zero water-pump candidates. Active Tourer/225xe/218d did not resolve as exact catalog models. None of those results established defect identity or remedy, so no retail link was forced. BMW/NHTSA primary sources retain bounded 135i HPFP, injector, wastegate and coolant-pump paths; bounded 228i timing-chain and 24V608 pump-connector recall paths; and government recall paths for the 225xe high-voltage battery and 218d EGR cooler. The distinct 1 Series PCV-heater recall and 2 Series side-head-protection recall remain controlled `insert: false` proposals. Sequential blind/edge verdicts `bmw1_blind:no-blocker`, `bmw1_edge:no-blocker`, `bmw2_blind:no-blocker`, `bmw2_edge:no-blocker`, `bmw2at_blind:no-blocker` and `bmw2at_edge:no-blocker` bind the exact reviewed configs and shared generator. Exact-before, three guarded transactions, exact-after verification and idempotent reapply all passed; full history verifies 55 manifests and 434 records without drift. Thirty-four focused tests, route ESLint and diff hygiene pass. Both local and Vercel webpack builds passed TypeScript and generated 1,531/1,531 static pages. Vercel reports target `production` with `au7o.io`, `www.au7o.io`, `autocarecompanion.vercel.app` and project aliases; both CDN and data caches were purged. Cache-busted production HTML renders all eight approved records while omitting all 16 archives and 86 removed URLs. Exact title/H1/Open Graph/Twitter/description/canonical/indexability checks pass at `2008-2013 BMW 1 Series Problems: 4 Known Issues`, `2014-2016 BMW 2 Series Problems: 2 Known Issues` and `BMW 2 Series Active Tourer Problems & Known Issues`; 38 live boundary-year API responses match every exposed manifest field with exact model boundaries and zero commerce. All routes retain `/get-started`, zero `Open Hub`, both DataRep badges and every warm-paper token. Together with the previously completed X5, BMW is Production-complete at four of 41 model groups; 3 Series is next and 37 BMW model groups remain.
- 2026-07-31: Production-verified the final Cadillac XT4, XT5, XT6 and XTS cohort on exact functional audit commit `0a5c3bbd68f5e6d58e843ca0a2cd5bc5ac4c52b1` and Ready Production deployment `dpl_EMyptzUp53w3zsL9Nea5awXnNxzL`. Thirty-six frozen records resolved to 14 published and 22 archived records; all 70 commerce claims and 140 legacy URL occurrences were removed, including all five claim/record/priority clicks, with zero commerce retained. Eight exact ShowMeTheParts subscription-API lookups were used only for candidate/fitment evidence: six returned no candidate, the XT6 transfer-case lookup returned only a generic differential pinion seal that did not establish the claimed PTU repair, and the XT6 AGM-battery lookup returned three fitment candidates that did not establish a defect or remedy. No retail link was forced. The distinct XT5 high-pressure fuel-pump emissions recall, XT6 obstructed-fuel-flow recall, XT6 blank-radio update, XT6 high-pressure fuel-pump emissions recall and XTS driver-airbag-inflator recall remain controlled `insert: false` proposals. Final independent verdicts `cadillac6_blind:no-blocker` and `cadillac6_edge:no-blocker` bind exact final config hashes XT4 `9b4b85a615fd8c2182707caa4d2bc195ed954f9e73d925674b4f971834505c7f`, XT5 `a922f98736ebc660a78fd9162891d30faa597ff2afafdff411fdda802cfd7e99`, XT6 `b13b0bf254065cc8b164af88b5197d6f7e4afd6b60e8ee4d769791c2b1f3b1aa`, XTS `74bf9879dccc26d0e586a0141cedf260e4cd8350702edd1ea04744e692e561e3` and shared core `7e108f0365d22e8e6747f5e4e82926650dd1fabbafdf6b429914ff26b1fdba51`. Exact-before, guarded apply, exact-after, after-state no-op and idempotent reapply all passed; full history verifies 52 manifests and 410 records without drift. Thirty-four focused tests, route ESLint and diff hygiene pass. Both local and Vercel webpack builds passed TypeScript and generated 1,531/1,531 static pages. Vercel reports target `production` with all production aliases; both CDN and data caches were purged. Cache-busted live HTML renders all 14 approved titles while omitting all 22 archived records and 140 removed URLs. Exact title/H1/Open Graph/Twitter/description/canonical/indexability checks pass at `2019-2020 Cadillac XT4 Problems: 3 Known Issues`, `2020-2021 Cadillac XT5 Problems: 2 Known Issues`, `2020-2021 Cadillac XT6 Problems: 1 Known Issue` and `2013-2019 Cadillac XTS Problems: 8 Known Issues`; 37 live boundary-year API responses match every exposed manifest field with exact model boundaries and zero commerce. All routes retain `/get-started`, zero `Open Hub`, both DataRep badges and every warm-paper token. Cadillac is Production-complete at 24 of 24 model groups; BMW is next.
- 2026-07-30: Production-verified the Cadillac Lyriq, Seville, SRX and STS cohort on exact functional audit commit `4d942757c095a5717f2b0acb7dbc1b350a080cda` and Ready Production deployment `dpl_DxUHZ3WdZ4n99hmHnTsdcvqqAZyC`. Twenty-three frozen records resolved to 10 published and 13 archived records; all 32 commerce claims and 32 legacy URL occurrences were removed, including both clicked/priority claims, with zero commerce retained. Exact ShowMeTheParts subscription-API lookups for SRX timing-chain and liftgate-strut paths, the Seville electronic-strut path and the STS timing-chain path resolved the requested vehicles but returned no usable product candidates, so no retail links were forced. The distinct Lyriq coolant-sensor-harness update and 2016 SRX liftgate-support-strut campaign remain controlled `insert: false` proposals instead of being merged into unrelated stable records. Final independent verdicts `cadillac5_blind:no-blocker` and `cadillac5_edge:no-blocker` bind exact final config hashes Lyriq `6d833827424caa8f1c68a452f3a6409c5c1225b8b0d4a06ac9c3453d4b611e5e`, Seville `785d6baefddd24a2c8845eaaf2d4233ba976d8f0297b8d777a54fa318391119b`, SRX `5711c5ea0a198059e97ffce45624984490cee044c7c92a9332273ae07e4841cb`, STS `85deb9e1c9fcda17af834b4252adec0d3e64c4e7a8002694bb424a865277d25d` and shared core `7e108f0365d22e8e6747f5e4e82926650dd1fabbafdf6b429914ff26b1fdba51`. Exact-before, guarded apply, exact-after, after-state no-op and idempotent reapply all passed; full history verifies 48 manifests and 374 records without drift. Forty-four focused tests and route ESLint pass. Both local and Vercel webpack builds passed TypeScript and generated 1,531/1,531 static pages. Vercel reports target `production`, aliased to `au7o.io`, and both CDN and data caches were purged. Cache-busted live HTML renders all 10 approved titles while omitting all 13 archived records and 32 removed URLs. Exact title/H1/Open Graph/Twitter/canonical/indexability checks pass at `2023-2025 Cadillac Lyriq Problems: 6 Known Issues`, `2002 Cadillac Seville Problems: 1 Known Issue`, `2010-2014 Cadillac SRX Problems: 2 Known Issues` and `2007-2011 Cadillac STS Problems: 1 Known Issue`; four live API responses cover all 10 published records with zero commerce. All routes retain six `/get-started` occurrences, zero `Open Hub`, both DataRep badges and all warm-paper tokens. Twenty of 24 Cadillac model groups are Production-complete, leaving XT4, XT5, XT6 and XTS.
- 2026-07-30: Production-verified the Cadillac ELR, Escalade, Escalade ESV and Fleetwood cohort on exact functional audit commit `a07571bce1939bd44ea485899ea9c011c790b1c6` and Ready Production deployment `dpl_3g6ESuEbiAyhF9tsNYEsob7dS3LD`. Thirty-four frozen records resolved to 24 published and 10 archived records; all 66 commerce claims and 89 legacy URL occurrences were removed, with zero commerce retained. Exact ShowMeTheParts subscription-API lookups for the ELR charging-receptacle and Fleetwood distributor paths resolved no usable product candidates, so no retail links were forced. Final independent verdicts `cadillac4_blind:no-blocker` and `cadillac4_edge:no-blocker` bind the reviewed configs and manifests. Exact-before, guarded apply, exact-after, no-op and idempotent reapply all passed, as did 34/34 focused tests. The local webpack build and Vercel build each passed TypeScript and generated 1,531/1,531 static pages. After CDN and data-cache purges, all four live routes returned 200 and indexable canonical metadata, rendered every published record while omitting every archived record and all former URLs, and passed 70 exact live API checks across affected and boundary years. Exact titles, descriptions, H1/Open Graph/Twitter labels, six `/get-started` occurrences, zero `Open Hub`, both DataRep badges and the warm-paper palette all pass. Sixteen of 24 Cadillac model groups are Production-complete, leaving eight.
- 2026-07-30: Production-verified the corrected Cadillac CTS-V, DeVille, DTS and Eldorado cohort on exact audit commit `02561dc2c8e843c1ce78e59b4718ea32665a7136` and Ready Production deployment `dpl_6oshD6SiRCP4ACzYPM7FUnH6xYRF`. The clean local build passed TypeScript and generated 1,529/1,529 static pages; the Vercel build passed TypeScript and generated 1,531/1,531. Vercel reports target `production` with `au7o.io`, `www.au7o.io`, `autocarecompanion.vercel.app` and project aliases; both CDN and data caches were purged. Cache-busted HTML returns 200 for all four routes and renders all six published records while omitting all 15 archived records and all 26 former URL occurrences. Exact titles/H1/OG/Twitter descriptions, canonicals, indexability, six `/get-started` occurrences, zero `Open Hub`, both DataRep badges and all warm-paper tokens pass on every route. Fifty-seven live API checks match every exposed manifest field across affected and boundary years, ignore four attempted `status=archived` overrides and preserve the CTS/CTS-V model boundary. Twelve of 24 Cadillac model groups are Production-complete, leaving 12.
- 2026-07-30: Corrected the Cadillac cohort's archive-only DeVille and DTS outcome before final release. One semantically consistent record per model now remains published under GM bulletin 01-06-01-011O: DeVille uses measured oil-consumption diagnosis with the bulletin's personal-use/maintenance/warranty conditions and under-4,000-mile exception; DTS requires external-leak source confirmation before rear-seal or oil-pan repair. Both remain diagnosis holds with zero commerce. Exact final verdicts `cadillac3_zero_route_blind:no-blocker` and `cadillac3_zero_route_edge:no-blocker` bind the amended configs/manifests. The guarded two-record correction applied from exact archive-only hashes, verified as exact after-state, and returned `already-applied` on re-apply; amended permanent manifests also verify as already applied. Full history remains drift-free across 151 manifests, 144 active batches, seven superseded legacy batches and 765 records. Final cohort disposition is six published and 15 archived, preserving non-empty indexable model hubs for all four scoped Cadillac routes while the exact-commit Production gate remains pending.
...
- 2026-07-29: Completed the accelerated Audi 100/90/Cabriolet database cohort. Twenty-three frozen records were handled through three independent schema-v2 packets/manifests but one shared NHTSA research and release pipeline: eight exact historical recall paths remain published and 15 unsupported or duplicate aggregations are archived. All 44 commerce claims and 80 URL occurrences are removed; no record was inserted. The old-campaign remedy language requires VIN/completion checks and current availability/cost confirmation rather than promising free service. Exact-before, guarded three-manifest apply, exact-after, no-op dry-run and idempotent reapply pass. Six commerce, 25 applicator/coverage, three candidate and one exact-model API test pass (35/35); route ESLint passes; full history verifies 123 manifests, 116 active batches, seven superseded legacy batches and 519 rows. Only the three exact slugs join the concise-title allowlist, with global SEO and the warm-paper/Get Started/DataRep design unchanged. Twenty-eight of 44 Audi model groups are database-audit complete; all three await one combined exact-commit Production gate.
- 2026-07-29: Production-verified Audi 100, Audi 90 and Audi Cabriolet on exact audit commit `f536f87f341af82286d1465de69e0c0e3e5737f6` and Ready Production deployment `dpl_DTo3wCND3E1umKw1UYQANXtsQUPh`. Both isolated local and Vercel builds passed TypeScript and generated 1,531/1,531 pages; the deployment owns all exact Production aliases, and both CDN and data caches were purged. Cache-busted HTML renders all eight approved records, omits all 15 archived records and 80 old URL occurrences, and passes exact title/description/canonical/indexability checks. All three pages retain six `/get-started` source occurrences, zero `Open Hub`, both DataRep badges and all three warm-paper colors. Seventeen cache-busted year-filtered API responses match every exposed manifest field with exact model boundaries and no archived or cross-model leakage. The three models are Production-complete, making 28 of 44 Audi model groups complete and leaving 16.
- 2026-07-29: Completed the accelerated Audi A1/A3/S3 database cohort across 26 separately guarded frozen records: six primary-source-bounded records remain published and 20 unsupported, duplicate or semantically mismatched aggregations are archived. A1 retains only the exact 2016 igniter recall; A3 retains the 2010-2015 2.0 TDI emissions scope, 2010-2012 injector-line recall, 2022 rearview-camera recall and 2020/2022-2024 coolant-pump diagnosis; S3 retains the matching 2020/2022-2024 coolant-pump diagnosis. All 48 commerce claims and 84 URL occurrences are removed, including two clicked/priority links; no row was inserted. Exact-before, one guarded three-manifest apply, exact-after, after-state no-op and idempotent reapply pass. Six commerce, 25 applicator/coverage, three candidate and one exact-model API test pass (35/35); page and route ESLint pass after a type-only route mapper cleanup with no runtime change. Full history verifies 126 manifests, 119 active batches, seven superseded legacy batches and 545 rows. Only `audi-a1`, `audi-a3` and `audi-s3` join the existing concise-title allowlist, with global SEO and the warm-paper/Get Started/DataRep design unchanged. Thirty-one of 44 Audi model groups are database-audit complete; all three await one combined exact-commit Production gate while the Production-complete count remains 28.
- 2026-07-29: Production-verified Audi A1, A3 and S3 on exact final commit `b1fe015fdd63fe827ec96af8b3025b8de79fb0dc` and Ready Production deployment `dpl_ER4E2utTwMXQhs4D3SQUk6k3BAFh`. Both isolated local and Vercel builds passed TypeScript and generated 1,531/1,531 pages; the deployment owns all exact Production aliases, and both CDN and data caches were purged. The live gate withheld closure on two earlier deployments until one-year/one-record audited metadata consistently collapsed `2016-2016` to `2016` and used singular `Known Issue` in title, description and FAQ paths; non-audited indexed metadata and visual behavior remain unchanged. Cache-busted HTML renders all six approved records, omits all 20 archived records and 84 old URL occurrences, and passes exact title/description/canonical/indexability checks. All pages retain six `/get-started` source occurrences, zero `Open Hub`, both DataRep badges and all three warm-paper colors. Twenty-seven cache-busted year-filtered API responses match every exposed manifest field across boundary and gap years with no archived or cross-model leakage. The three models are Production-complete, making 31 of 44 Audi model groups complete and leaving 13.
...
### 2026-07-31 - BMW 1 Series, 2 Series and 2 Series Active Tourer release review

- intent_gap: 0
- bad_spec: 0
- patch: 8: (high 6, medium 2)
- defer: 2: (both retained as `insert: false` proposals because their exact recall identities do not match a frozen stable record)
- reject: 0
- addressed_findings:
  - `[high]` `[patch]` Restricted the four retained 1 Series paths to exact E82/E88 135i/N54/N55 bulletin populations. Removed the false 1M, N52, broad-generation, automatic-part-replacement and current-free-warranty implications.
  - `[high]` `[patch]` Replaced the all-turbo 2 Series water-pump aggregation with VIN-first NHTSA recall 24V608 for certain 2014-2016 228i/228i xDrive N20/N26 vehicles, and restricted the timing-chain path to SIB 11 03 17's F22/F23 N20/N26 production-through-February-2015 population.
  - `[high]` `[patch]` Restricted the Active Tourer high-voltage-battery card to the 2020 F2AT Safety Gate production dates and the EGR card to the officially documented 218d/B47 population. Removed unsupported battery-aging, B37/other-derivative and universal repair claims.
  - `[high]` `[patch]` Archived all duplicate, maintenance-like, forum-only, mixed-powertrain or wrong-chassis aggregations instead of preserving their retail claims: seven 1 Series records, four 2 Series records and five Active Tourer records.
  - `[medium]` `[patch]` Preserved newly surfaced PCV-heater and side-head-protection recalls only as controlled no-insert proposals rather than repurposing unrelated stable IDs.
  - `[medium]` `[patch]` Added only `bmw-1-series`, `bmw-2-series` and `bmw-2-series-active-tourer` to the existing concise-title allowlist; global indexed metadata behavior and the warm-paper/Get Started/DataRep design remain unchanged.
- review_notes:
  - Sequential exact verdicts are `bmw1_blind:no-blocker`, `bmw1_edge:no-blocker`, `bmw2_blind:no-blocker`, `bmw2_edge:no-blocker`, `bmw2at_blind:no-blocker` and `bmw2at_edge:no-blocker`.
  - The shared generator SHA-256 is `7e108f0365d22e8e6747f5e4e82926650dd1fabbafdf6b429914ff26b1fdba51`. Config SHA-256 values are 1 Series `88aa52126006e74afc6f4f07f6f98ee996417bbe16f69e31ec94e4d4c7771ed7`, 2 Series `478c7d06ec98a01d765217ded6a7fcc1a93be9f38195251900b06c55b77070f1` and Active Tourer `e04d5b4f3984f1753ee98ee53157bce356d9c27193c524893ae4f5fddff9d594`.
  - Frozen snapshot file SHA-256 is `5d9038c04baaff4b03a9df60fa76fe28a7187c144878b4c847dbc86152cc19c0`; logical snapshot SHA-256 is `1cf03c45b76180a14f4739d6179c3677fba2e68f9e782decd6522d1d5d6dbf9b`.
  - Packet SHA-256 values are 1 Series `a498864eee9fac13d7ec187b3a92aa7d47ce7904b8694b5e007eb90dee1d5df1`, 2 Series `f0181b023b2dcda6b487b0e6f6cd43b7fe68ab7be8241c8a7449a023a34e55d1` and Active Tourer `d9fb4bef01471e3c2c5ded4b6881f3f9e8faab639ed0ab8d274336a3714aefde`.
  - Canonical manifest SHA-256 values are 1 Series `075f4d18e6b410e608b73550a591e6819ff63ef85356c3570f791fe4aa93d455`, 2 Series `3e796c9337c54113ab82fe16aebdd2d2851d05013f21a044057b22e67bab2b8e` and Active Tourer `dc56d86fdf2b22d6a937d520a7452fafb9e11c32abcde583ad52ea6b8e954ff6`.
  - Manifest file SHA-256 values are 1 Series `4fbfbc99b3003ab3f39334e84b0a08259c4f802dfb454e91aff5d2c58e5d0955`, 2 Series `dd18db6bd57bf73c4c65844ef638bd9bf5ccaf0e0f59f229191064939361da92` and Active Tourer `390320f4ff24a5145aa8f16fd0c8aa7d921c5eb8c6bc65598c86ddc93292a1a2`.
  - Receipt file SHA-256 values are 1 Series `e7dd9794e7c704cd636b5aca37f1c21c2f33e817ff95c76a94332f2e74c8a13f`, 2 Series `fe19052126fa8d1a56c7a9c8fc82922bd3e746203e1f868ffb1ede16aaf133f1` and Active Tourer `4c803e63994d5ad6e6e216ada589862d710cab539d11fb19c83c31c7a906c498`.
  - Production titles are `2008-2013 BMW 1 Series Problems: 4 Known Issues | Au7o`, `2014-2016 BMW 2 Series Problems: 2 Known Issues | Au7o` and `BMW 2 Series Active Tourer Problems & Known Issues | Au7o`.

### 2026-07-31 - Cadillac XT4, XT5, XT6 and XTS release review

- intent_gap: 0
- bad_spec: 0
- patch: 5: (high 3, medium 2)
- defer: 5: (all retained as `insert: false` proposals because their exact findings do not match a frozen stable identity)
- reject: 0
- addressed_findings:
  - `[high]` `[patch]` Archived the frozen XT5 shift-to-park card because current GM bulletin 19-NA-206 does not cover any Cadillac, and archived the mixed eight-/nine-speed fluid card because 18-NA-355 does not cover XT5.
  - `[high]` `[patch]` Bounded the XT4 9T50 record to the glycol-test decision tree in 18-NA-378 and the XT5/XT6 shudder records to PIP5608F instead of presenting fluid or additive replacement as a universal remedy.
  - `[high]` `[patch]` Kept all recalled conditions VIN-first and separated the five newly surfaced recall/update identities into proposal-only records instead of mutating unrelated frozen IDs.
  - `[medium]` `[patch]` Replaced unsupported XTS aggregations with eight exact recall, bulletin or diagnosis paths, including the superseding 18-NA-358 shift-shudder bulletin.
  - `[medium]` `[patch]` Added only `cadillac-xt4`, `cadillac-xt5`, `cadillac-xt6` and `cadillac-xts` to the existing concise-title allowlist; global indexed metadata behavior and the warm-paper/Get Started/DataRep design remain unchanged.
- review_notes:
  - Final exact verdicts are `cadillac6_blind:no-blocker` and `cadillac6_edge:no-blocker`.
  - The frozen snapshot file SHA-256 is `6e4c8d64ced097e83111d27c7f46e1f1c08b79dc40423fee81ebc9d9c54cd455` and logical SHA-256 is `3ee40713b2b5f1bd845d6118be79fc8486956e01d41eb5a8609a85aba77a5102`.
  - Packet SHA-256 values are XT4 `df9e4b8c4993b977c89ee4d3ebefa38179c665a8aa3bf6a10c044a767b5944bf`, XT5 `ef571bb77e2b2736e5a545667f5bfd55ed1b5f835f885947fcd4b8c4fdef721b`, XT6 `895013b356ba9c15a496e22cd37f57eed42037692f24cb136dd0513cdc42b3bd` and XTS `101a697c84a4c14791f9c9393b12349350966070af69820d51908a594c7a160a`.
  - Canonical manifest SHA-256 values are XT4 `d0407f8d02cbe292c2b09d89a67328d7b05b33385e6182cd0e836eea8dea2546`, XT5 `02825cf5085c5b3f8452206e52c456995d6837e1d9df69f686c34704eb82cb5d`, XT6 `72f83ffe2e1c0bf714654640d6214d165afbdda66e1ebb2bb92e1a008bcfdfbb` and XTS `d6f7fb7458b038134595bf7358d34939cfe4088d1b48a2800d26cfbaf2e34aaa`.
  - Manifest file SHA-256 values are XT4 `3b1b940465a73e5acf819bdbba5da5b8471ec8d7498456d323d355dc9c03e27f`, XT5 `41188db52ceb9ffdb7e3fd11c528bc505a7ca2a4c297544d213ae8bd953590f0`, XT6 `5cbf4c92920931a6424ac455c620ca00e15d0abdeab9fbbdcac362d4b2f01a39` and XTS `90be81356294043a8db86aba0c88d71edd084963efc006725c0e184d5f4819b4`.
  - Receipt file SHA-256 values are XT4 `12066fa2409a94d924daef07188da760602fdda390c32d50f221f81dfc28883c`, XT5 `9422e62edf9b1650262e6ddff109758ed7d04df01b86a67d1f11a3400e558ccd`, XT6 `fd54481f0ea7f780ada8cfd58a841f0b51d8dd70adb8f8d2849aff57ce80d167` and XTS `c6214f664ed91e5537d2bac95c867595305c7e3d392ca2cd5fdd1e8d31ff2a6c`.
  - Production titles are `2019-2020 Cadillac XT4 Problems: 3 Known Issues | Au7o`, `2020-2021 Cadillac XT5 Problems: 2 Known Issues | Au7o`, `2020-2021 Cadillac XT6 Problems: 1 Known Issue | Au7o` and `2013-2019 Cadillac XTS Problems: 8 Known Issues | Au7o`.

### 2026-07-30 - Cadillac Lyriq, Seville, SRX and STS release review

- intent_gap: 0
- bad_spec: 0
- patch: 10: (high 4, medium 6, low 0)
- defer: 2: (both retained as `insert: false` proposals because their exact findings do not match a frozen stable identity)
- reject: 0
- addressed_findings:
  - `[high]` `[patch]` Archived the Lyriq heat-pump/no-heat aggregation rather than repurposing its stable ID for GM's distinct 2024 RWD coolant-sensor-harness update; the supported harness finding remains proposal-only.
  - `[high]` `[patch]` Isolated the expired 2016 SRX liftgate-support-strut campaign from the 2010-2014 RPO TB5 gas-strut wear path and retained it proposal-only instead of merging two mechanisms and populations.
  - `[high]` `[patch]` Replaced the generic Seville suspension warning with an exact 2002 STS/CVRSS RPO F45 diagnosis path, matching the VIN 9 OEM damper-actuator procedure and C0577 circuit example without asserting that the strut hardware failed.
  - `[high]` `[patch]` Engine-gated the STS and SRX timing-chain paths to the exact High Feature V6 RPO families and corrected LFW to 3.0L.
  - `[medium]` `[patch]` Replaced the dead SRX PI1186 NHTSA object with the working official `SB-10070199-9133.pdf` deep link and limited the public record to PI1186's 2010-2014 RPO TB5 scope.
  - `[medium]` `[patch]` Removed unsupported Lyriq recall population wording and limited stabilizer-bracket remedy copy to inspection and necessary fastening supported by the cited campaign.
  - `[medium]` `[patch]` Added only the four exact audited Cadillac slugs to the existing concise-title allowlist; global metadata behavior and the warm-paper/Get Started/DataRep design remain unchanged.
- review_notes:
  - Final exact verdicts are `cadillac5_blind:no-blocker` and `cadillac5_edge:no-blocker`.
  - ShowMeTheParts returned zero candidates for all four exact candidate/fitment lookups, so this cohort intentionally retains zero commerce.
  - Production titles are `2023-2025 Cadillac Lyriq Problems: 6 Known Issues | Au7o`, `2002 Cadillac Seville Problems: 1 Known Issue | Au7o`, `2010-2014 Cadillac SRX Problems: 2 Known Issues | Au7o` and `2007-2011 Cadillac STS Problems: 1 Known Issue | Au7o`.

### 2026-07-30 - Cadillac ELR, Escalade, Escalade ESV and Fleetwood release review

- intent_gap: 0
- bad_spec: 0
- patch: 12: (high 5, medium 7, low 0)
- defer: 7: (all retained as `insert: false` proposals because their stable identities do not match a frozen record)
- reject: 0
- addressed_findings:
  - `[high]` `[patch]` Archived two Escalade ESV records whose proposed 2015 transfer-case and liftgate rewrites were not semantically compatible with their frozen issue identities; the supported findings remain proposal-only.
  - `[high]` `[patch]` Archived the Fleetwood OptiSpark path because its source established only a generic engine-miss diagnosis and did not substantiate the claimed OptiSpark/LT1 failure.
  - `[high]` `[patch]` Recast the Escalade ESV alarm-loop diagnosis as a de-energized, qualified-technician BCM-terminal procedure and removed unsafe owner-facing ohmmeter instructions.
  - `[high]` `[patch]` Split PIT4954C/D by its exact condition: the 2009-and-earlier hose path remains separate from normal key-up compressor silence, with the documented 10 psi threshold preserved.
  - `[high]` `[patch]` Restricted the ELR brake-burnish path to inspected cosmetic lot rot at 0-200 miles; higher-mile corrosion, flaking or braking symptoms remain professional-inspection cases.
  - `[medium]` `[patch]` Removed the unsupported ELR CUE touch-screen symptom and corrected three invalid citation enums, one invalid category, and swapped ELR manual/NHTSA provenance labels before manifest generation.
  - `[medium]` `[patch]` Preserved all seven additional sourced findings as non-inserting proposals rather than mutating unrelated stable IDs or expanding the frozen catalog without an approved insertion path.
- review_notes:
  - Final exact hashes are ELR `2c15bf7afdd99d3bffd9fe36d13d66f879f727b65d402b9b9c907f35feee78ab`, Escalade `ff6e10995c61d301ae64f5b2bea882665bc683a1e9fc8e327d17bf88fae7b8cc`, Escalade ESV `389094b5d88998e65cbb7c7c9cf1ab9c7d7650c2ce53807a932d7cbe86d2c9b7`, Fleetwood `5ae004e34c7ab0bd868c2c4d3ed4062581466974b6f4fd6fe0ea5d9f209518b4`, and shared core `7e108f0365d22e8e6747f5e4e82926650dd1fabbafdf6b429914ff26b1fdba51`.
  - Final exact verdicts are `cadillac4_blind:no-blocker` and `cadillac4_edge:no-blocker`.
  - Production titles are `2014-2016 Cadillac ELR Problems: 11 Known Issues | Au7o`, `2007-2024 Cadillac Escalade Problems: 5 Known Issues | Au7o`, `Cadillac Escalade ESV Problems & Known Issues | Au7o`, and `1994 Cadillac Fleetwood Problems: 1 Known Issue | Au7o`.

### 2026-07-30 — Cadillac DeVille and DTS zero-route SEO correction
...
- reject: 0
- addressed_findings:
  - `[high]` `[patch]` Replaced the archive-only DeVille and DTS outcomes with narrow, semantically consistent GM 01-06-01-011O diagnosis paths so neither audited indexed model hub collapses into a zero-card 404/soft-404 candidate.
  - `[medium]` `[patch]` Aligned both one-time correction manifests' `contentUpdateSummary` fields byte-for-byte with the permanent config `after.summary` values, preserving idempotent amended-manifest verification.
  - `[medium]` `[patch]` Added GM's break-in exception: do not begin the normal oil-consumption test before 4,000 miles unless use exceeds one quart per 1,000 miles.
